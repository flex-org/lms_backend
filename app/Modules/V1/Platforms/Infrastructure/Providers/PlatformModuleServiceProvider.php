...
use App\Modules\V1\Platforms\Infrastructure\Persistence\Repositories\EloquentDynamicFeatureRepository;
...
class PlatformModuleServiceProvider extends AbstractModuleServiceProvider
{
    protected function registerBindings(): void
    {
        ...
        $this->app->bind(DynamicFeatureRepositoryInterface::class, EloquentDynamicFeatureRepository::class);
    }
}
